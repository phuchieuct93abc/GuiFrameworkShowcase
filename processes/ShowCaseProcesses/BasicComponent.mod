[Ivy]
[>Created: Wed Aug 02 16:06:51 ICT 2017]
...
Bt0 @RichDialog f5 '' #zField
Bt0 @PushWFArc f6 '' #zField
...
Bt0 f5 targetWindow NEW #txt
Bt0 f5 targetDisplay TOP #txt
Bt0 f5 startMethod start() #txt
Bt0 f5 type ch.axonivy.fintech.showcaseProcesses.basicComponent #txt
Bt0 f5 requestActionDecl '<> param;' #txt
Bt0 f5 responseActionDecl 'ch.axonivy.fintech.showcaseProcesses.basicComponent out;
' #txt
Bt0 f5 responseMappingAction 'out=in;
' #txt
Bt0 f5 isAsynch false #txt
Bt0 f5 isInnerRd false #txt
Bt0 f5 328 42 112 44 0 -8 #rect
Bt0 f5 @|RichDialogIcon #fIcon
Bt0 f6 expr out #txt
Bt0 f6 280 64 328 64 #arcP
Bt0 f2 expr out #txt
Bt0 f2 440 64 497 64 #arcP
...
Bt0 f3 mainOut f6 tail #connect
Bt0 f6 head f5 mainIn #connect
Bt0 f5 mainOut f2 tail #connect
