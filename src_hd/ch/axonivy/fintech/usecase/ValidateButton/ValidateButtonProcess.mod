...
>Proto Bs0 Bs0 ValidateButtonProcess #zField
Bs0 f0 guid 15D7DC04055859EE #txt
Bs0 f0 type ch.axonivy.fintech.usecase.ValidateButton.ValidateButtonData #txt
...
Bs0 f1 type ch.axonivy.fintech.usecase.ValidateButton.ValidateButtonData #txt
Bs0 f1 499 51 26 26 0 12 #rect
Bs0 f1 @|RichDialogProcessEndIcon #fIcon
Bs0 f3 guid 15D7DC0406BE6D9A #txt
Bs0 f3 type ch.axonivy.fintech.usecase.ValidateButton.ValidateButtonData #txt
Bs0 f3 actionDecl 'ch.axonivy.fintech.usecase.ValidateButton.ValidateButtonData out;
' #txt
...
Bs0 f4 type ch.axonivy.fintech.usecase.ValidateButton.ValidateButtonData #txt
Bs0 f4 guid 15D7DC0406B33F98 #txt
Bs0 f4 211 147 26 26 0 12 #rect
Bs0 f4 @|RichDialogEndIcon #fIcon
Bs0 f5 expr out #txt
Bs0 f5 109 160 211 160 #arcP
Bs0 f6 actionDecl 'ch.axonivy.fintech.usecase.ValidateButton.ValidateButtonData out;
' #txt
...
in.data = new BasicComponentData();
in.data.maxLength = "Over max length";
...
>Proto Bs0 .type ch.axonivy.fintech.usecase.ValidateButton.ValidateButtonData #txt
